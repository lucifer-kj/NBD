...
const Footer = () => {
  return (
    <footer className="bg-[var(--islamic-green-dark)] text-white pt-16 pb-8 relative overflow-hidden">
      {/* Subtle gold top accent line */}
      <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-[var(--islamic-gold)] to-transparent" />

      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-12">
          {/* Brand & About */}
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-headings font-bold mb-4 text-[var(--islamic-gold)] tracking-wide">
              Naaz Book Depot
            </h3>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-[var(--islamic-gold)] hover:text-white transition-colors duration-300"
            >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider mb-5 text-white/90">Quick Links</h4>
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-white/60 hover:text-[var(--islamic-gold)] transition-colors duration-300 text-sm">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/books" className="text-white/60 hover:text-[var(--islamic-gold)] transition-colors duration-300 text-sm">
                  Islamic Books
                </Link>
              </li>
              <li>
                <Link href="/atar" className="text-white/60 hover:text-[var(--islamic-gold)] transition-colors duration-300 text-sm">
                  Premium Atar
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-white/60 hover:text-[var(--islamic-gold)] transition-colors duration-300 text-sm">
                  Our Legacy
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-white/60 hover:text-[var(--islamic-gold)] transition-colors duration-300 text-sm">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider mb-5 text-white/90">Contact Us</h4>
        ...
        {/* Copyright */}
        <div className="text-center pt-8 border-t border-white/10 text-white/40 text-xs tracking-wide">
