    ...
    <footer className="bg-[var(--islamic-green-dark)] text-white/90 pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="hidden md:grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-5">
              ...
              <a
                ...
                className="w-9 h-9 flex items-center justify-center rounded-full border border-white/10 bg-white/5 hover:bg-[var(--islamic-gold)] hover:text-[var(--islamic-green-dark)] hover:border-[var(--islamic-gold)] hover:-translate-y-0.5 transition-all duration-300 text-white/80"
              >
                <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 192 192" aria-hidden="true">
          ...
          <div className="col-span-2 lg:col-span-1 border-t border-white/10 pt-6 lg:border-t-0 lg:pt-0">
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              <p className="text-xs font-bold uppercase tracking-wider mb-3 text-[var(--islamic-gold)]">Accepted Payments</p>
        ...
        <div className="text-center pt-8 border-t border-white/10 text-white/50 text-xs tracking-wide font-medium flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="order-1 md:order-2 flex flex-col items-center md:items-end gap-2">
            <div className="flex items-center gap-2.5 opacity-80 text-white">
              <span className="border border-white/20 px-1.5 py-0.5 rounded text-[9px] tracking-wider font-extrabold uppercase bg-white/5">Visa</span>
              <span className="border border-white/20 px-1.5 py-0.5 rounded text-[9px] tracking-wider font-extrabold uppercase bg-white/5">Mastercard</span>
              <span className="border border-white/20 px-1.5 py-0.5 rounded text-[9px] tracking-wider font-extrabold uppercase bg-white/5">UPI</span>
              <span className="border border-white/20 px-1.5 py-0.5 rounded text-[9px] tracking-wider font-extrabold uppercase bg-white/5">RuPay</span>
            </div>
